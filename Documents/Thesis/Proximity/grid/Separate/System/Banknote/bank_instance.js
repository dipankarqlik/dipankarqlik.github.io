var mainChartnew = function () {
  ...
  function drawgrid(canvasnew, grid, size = { width: 5, height: 5 }) {
    ...
    var color_scale = d3.scaleOrdinal().range(["#3a9276", "#fb8150", "white"]);
    ...
    canvasnew
      ...
      .join(
        (enter) => {
          ...
          canvasnew.append("circle").attr("cx",900).attr("cy",40).attr("r", 6).style("fill", "#3a9276")
          canvasnew.append("circle").attr("cx",900).attr("cy",60).attr("r", 6).style("fill", "#fb8150")
          canvasnew.append("text").attr("x", 920).attr("y", 40).text("Class 0").style("font-size", "13px").attr("alignment-baseline","middle")
          canvasnew.append("text").attr("x", 920).attr("y", 60).text("Class 1").style("font-size", "13px").attr("alignment-baseline","middle")
        },
        (update) => {},
        (exit) => {}  
      );
